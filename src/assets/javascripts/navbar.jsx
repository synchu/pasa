            ...
            <nav class="navbar navbar-default navbar-fixed-top">
                <div class="container">
                    ...
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="#"><img class="brandimage img-responsive" alt="Brand"
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        <ul class="nav navbar-nav">
                            <li><a href="products.html">Products<span class="sr-only">(current)</span></a></li>
                            ...
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a href="#">New resource</a></li>
                                    <li><a href="#">New calendar</a></li>
                                    <li role="separator" class="divider"></li>
                                    <li><a href="#">New task completion time</a></li>
                                    <li role="separator" class="divider"></li>
